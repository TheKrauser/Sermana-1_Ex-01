function contarVogais(parametro) {
    var minusculo = parametro.toLowerCase(); //Mudar toda a string para letra minúscula
    var count = minusculo.match(/[aáàãâeéêiíîoóõôuúû]/gi); //Comando para checar na string inteira e retornar todos os resultados relacionados com o que está dentro do /[]/
    if (!count)
